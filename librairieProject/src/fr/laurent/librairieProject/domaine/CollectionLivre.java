 ...
 * 
 * @author Laurent
 * Une collection de livres est un tableau d'objet de type Livre. La classe est une classe fille de Vector<Livre>. Elle hérite donc de son comportement.
 */
public class CollectionLivre extends Vector<Livre> {
	...
	/**
	 * Constructeur par copie. L'objet instancié sera différent de celui référencé par le paramètre.
	...
	Boolean supprimer(Livre livre)
	{
		return super.remove(livre);
	}
